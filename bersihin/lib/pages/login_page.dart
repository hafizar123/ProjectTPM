...
class _LoginPageState extends State<LoginPage> {
  ...
  // ZHANGG! Fungsi sakti buat maksa balik ke Home pak!
  void _backToHome() {
    Navigator.pushAndRemoveUntil(
      context,
      MaterialPageRoute(builder: (context) => const HomePage()),
  ...
  Widget build(BuildContext context) {
    // ZHANGG! PopScope biar tombol back bawaan HP juga nurut pak!
    return PopScope(
      canPop: false,
              ...
              child: Padding(
                ...
                child: Container(
                  ...
                  child: IconButton(
                    ...
                    onPressed: _backToHome, // ZHANGG! Tembak fungsi nebas histori pak!
                  ),
                ),
              ),
            ),
